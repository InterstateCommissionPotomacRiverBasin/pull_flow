...
#                                "seneca", "shen_mill", "unity"),
              labels.vec = c("Bennett Creek at Park Mills, MD" = "bennett",
                             "Cedar Run near Catlett, VA" = "catlett",
                             "conoco" = "Conococheague Creek at Fairfview, MD",
                              "goose" = "Goose Creek near Leesburg, VA",
                              "hawlings" = "Hawlings River near Sandy Spring, MD",
                              ...
                              "unity" = "Patuxent River near Unity, MD"),
#              color.vec = c("bennett", "catlett", "conoco",
#                             "goose",
#                             "mon_jug",
#                             "barnum",
#                             "kitzmiller",
